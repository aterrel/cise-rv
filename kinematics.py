...
print latex(E(xf_uncertain, evaluate=False))
print E(xf_uncertain).evalf()
print Var(xf_uncertain).evalf()
...
print "\n\nComplex probability"
print P(theta_uncertain>pi/4, xf_uncertain>16, numsamples=1000)
